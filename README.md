...
3. Execute the following command
    ...
    ```
 Fot more detail please check the inplementation guid in [guide execution.pdf](/example/https://github.com/SEMIAGUESMI/MEV_Bet_Oracle/blob/master/guide%20execution.pdf)
